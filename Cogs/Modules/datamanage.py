...
class DataSelector(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if data_type == 'Infractions':
            ...
            view.add_item(DataSelector(interaction.user))
            embed = discord.Embed(title="Partnerships Data", description="**Erase Partnerships:** This will erase all partnership data every partnership data will be deleted. Logged partnership message posts won't be deleted only the data.\n**Erase Partnership Config:** This will erase the configuration for this module.", color=discord.Color.dark_embed())
            embed.set_thumbnail(url=interaction.guild.icon)
            embed.set_author(name=interaction.guild.name, icon_url=interaction.guild.icon)
            await interaction.response.edit_message(embed=embed, view=view)
            ...
            view.add_item(DataSelector(interaction.user))
            embed = discord.Embed(title="Suspensions Data", description="**Erase Suspensions:** This will erase all suspensions. This will not give back their roles and will not removed suspension posts.\n**Erase Suspensions Configuration:** This will erase the configuration for this module.", color=discord.Color.dark_embed())
            embed.set_thumbnail(url=interaction.guild.icon)
            embed.set_author(name=interaction.guild.name, icon_url=interaction.guild.icon)
            await interaction.response.edit_message(embed=embed, view=view)    
            ...
            view.add_item(DataSelector(interaction.user))
            embed = discord.Embed(title="Staff Feedback Data", description="**Erase Staff Feedback:** This will erase all staff feedback. This will not remove already posted feedbacks messages.\n**Erase Staff Feedback Configuration:** This will erase the configuration for this module.", color=discord.Color.dark_embed())
            embed.set_thumbnail(url=interaction.guild.icon)
            embed.set_author(name=interaction.guild.name, icon_url=interaction.guild.icon)
            await interaction.response.edit_message(embed=embed, view=view)
