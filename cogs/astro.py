...
class HelpdeskDropdown(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if selected == 'What is Astro Birb?':
            ...
            embed = discord.Embed(title="## <:Messages:1148610048151523339> What is Quota?", description="Quota is a Discord moderation bot designed to manage message quotas for staff members, ensuring their activity levels are met and helping identify potential areas for improvement or necessary punitive actions.")
        elif selected == 'How do I become staff here?':
            embed = discord.Embed(title="## <:leaf:1160541147320553562> How do I become staff?", description="Currently support & QA is handpicked meaning you have to show your activity in the support server by either answering support forums or activily talking in the server.")
        elif selected == 'Whats the servers rules?':
            embed = discord.Embed(title="## 🌿 Community Guidelines", description=f"* **Respectful Conduct.** Let's keep the atmosphere respectful and welcoming. Avoid spam, NSFW content, advertising, and political discussions. Help us maintain a community free from these topics in both general discussions and private messages.\n* **Maturity Matters.** When a healthy debate begins to escalate into an argument, consider taking a step back. Our team is here to assist, so please cooperate with their guidance. We're all striving for a positive environment.\n* **Mindful Conversations.** Join us in keeping conversations relevant to their respective channels and maintaining a high standard of quality. Engage in meaningful discussions that contribute positively to our volunteer-driven Discord community.\n\nYour adherence to these guidelines ensures that our community remains a friendly and enjoyable space for all members. Thank you for your cooperation! 🌿")
